...
typedef struct _Xchain__Contract__Sdk__PingRequest
    Xchain__Contract__Sdk__PingRequest;
typedef struct _Xchain__Contract__Sdk__PingResponse
    Xchain__Contract__Sdk__PingResponse;
typedef struct _Xchain__Contract__Sdk__NativeCallRequest
    Xchain__Contract__Sdk__NativeCallRequest;
typedef struct _Xchain__Contract__Sdk__NativeCallResponse
...
typedef struct _Xchain__Contract__Sdk__SyscallHeader
    Xchain__Contract__Sdk__SyscallHeader;
typedef struct _Xchain__Contract__Sdk__PutRequest
    Xchain__Contract__Sdk__PutRequest;
typedef struct _Xchain__Contract__Sdk__PutResponse
    Xchain__Contract__Sdk__PutResponse;
typedef struct _Xchain__Contract__Sdk__GetRequest
    Xchain__Contract__Sdk__GetRequest;
typedef struct _Xchain__Contract__Sdk__GetResponse
    Xchain__Contract__Sdk__GetResponse;
typedef struct _Xchain__Contract__Sdk__DeleteRequest
    Xchain__Contract__Sdk__DeleteRequest;
typedef struct _Xchain__Contract__Sdk__DeleteResponse
    Xchain__Contract__Sdk__DeleteResponse;
typedef struct _Xchain__Contract__Sdk__IteratorRequest
    Xchain__Contract__Sdk__IteratorRequest;
typedef struct _Xchain__Contract__Sdk__IteratorItem
    Xchain__Contract__Sdk__IteratorItem;
typedef struct _Xchain__Contract__Sdk__IteratorResponse
    Xchain__Contract__Sdk__IteratorResponse;
typedef struct _Xchain__Contract__Sdk__QueryTxRequest
    Xchain__Contract__Sdk__QueryTxRequest;
typedef struct _Xchain__Contract__Sdk__QueryTxResponse
    Xchain__Contract__Sdk__QueryTxResponse;
typedef struct _Xchain__Contract__Sdk__QueryBlockRequest
    Xchain__Contract__Sdk__QueryBlockRequest;
typedef struct _Xchain__Contract__Sdk__QueryBlockResponse
    Xchain__Contract__Sdk__QueryBlockResponse;
typedef struct _Xchain__Contract__Sdk__TransferRequest
    Xchain__Contract__Sdk__TransferRequest;
typedef struct _Xchain__Contract__Sdk__TransferResponse
    Xchain__Contract__Sdk__TransferResponse;
typedef struct _Xchain__Contract__Sdk__ContractCallRequest
    Xchain__Contract__Sdk__ContractCallRequest;
typedef struct _Xchain__Contract__Sdk__ContractCallResponse
    Xchain__Contract__Sdk__ContractCallResponse;
typedef struct _Xchain__Contract__Sdk__CrossContractQueryRequest
    Xchain__Contract__Sdk__CrossContractQueryRequest;
typedef struct _Xchain__Contract__Sdk__CrossContractQueryResponse
...
typedef struct _Xchain__Contract__Sdk__SetOutputRequest
    Xchain__Contract__Sdk__SetOutputRequest;
typedef struct _Xchain__Contract__Sdk__SetOutputResponse
    Xchain__Contract__Sdk__SetOutputResponse;
typedef struct _Xchain__Contract__Sdk__GetCallArgsRequest
...
typedef struct _Xchain__Contract__Sdk__Transaction
    Xchain__Contract__Sdk__Transaction;
typedef struct _Xchain__Contract__Sdk__Block Xchain__Contract__Sdk__Block;
typedef struct _Xchain__Contract__Sdk__GetAccountAddressesRequest
    Xchain__Contract__Sdk__GetAccountAddressesRequest;
typedef struct _Xchain__Contract__Sdk__GetAccountAddressesResponse
    Xchain__Contract__Sdk__GetAccountAddressesResponse;
typedef struct _Xchain__Contract__Sdk__PostLogRequest
    Xchain__Contract__Sdk__PostLogRequest;
typedef struct _Xchain__Contract__Sdk__PostLogResponse
    Xchain__Contract__Sdk__PostLogResponse;
typedef struct _Xchain__Contract__Sdk__EmitEventRequest
    Xchain__Contract__Sdk__EmitEventRequest;
typedef struct _Xchain__Contract__Sdk__EmitEventResponse
...
#define XCHAIN__CONTRACT__SDK__PING_REQUEST__INIT             \
    {                                                         \
        PROTOBUF_C_MESSAGE_INIT(                              \
            &xchain__contract__sdk__ping_request__descriptor) \
    }
...
#define XCHAIN__CONTRACT__SDK__PING_RESPONSE__INIT             \
    {                                                          \
        PROTOBUF_C_MESSAGE_INIT(                               \
            &xchain__contract__sdk__ping_response__descriptor) \
    }
...
#define XCHAIN__CONTRACT__SDK__NATIVE_CALL_REQUEST__INIT             \
    {                                                                \
        PROTOBUF_C_MESSAGE_INIT(                                     \
            &xchain__contract__sdk__native_call_request__descriptor) \
        , 0                                                          \
    }
...
#define XCHAIN__CONTRACT__SDK__NATIVE_CALL_RESPONSE__INIT             \
    {                                                                 \
        PROTOBUF_C_MESSAGE_INIT(                                      \
            &xchain__contract__sdk__native_call_response__descriptor) \
    }
...
#define XCHAIN__CONTRACT__SDK__PUT_REQUEST__INIT             \
    {                                                        \
        PROTOBUF_C_MESSAGE_INIT(                             \
            &xchain__contract__sdk__put_request__descriptor) \
        , NULL, {0, NULL}, { 0, NULL }                       \
    }
...
#define XCHAIN__CONTRACT__SDK__PUT_RESPONSE__INIT             \
    {                                                         \
        PROTOBUF_C_MESSAGE_INIT(                              \
            &xchain__contract__sdk__put_response__descriptor) \
    }
...
#define XCHAIN__CONTRACT__SDK__GET_REQUEST__INIT             \
    {                                                        \
        PROTOBUF_C_MESSAGE_INIT(                             \
            &xchain__contract__sdk__get_request__descriptor) \
        , NULL, { 0, NULL }                                  \
    }
...
#define XCHAIN__CONTRACT__SDK__GET_RESPONSE__INIT             \
    {                                                         \
        PROTOBUF_C_MESSAGE_INIT(                              \
            &xchain__contract__sdk__get_response__descriptor) \
        , { 0, NULL }                                         \
    }
...
#define XCHAIN__CONTRACT__SDK__DELETE_REQUEST__INIT             \
    {                                                           \
        PROTOBUF_C_MESSAGE_INIT(                                \
            &xchain__contract__sdk__delete_request__descriptor) \
        , NULL, { 0, NULL }                                     \
    }
...
#define XCHAIN__CONTRACT__SDK__DELETE_RESPONSE__INIT             \
    {                                                            \
        PROTOBUF_C_MESSAGE_INIT(                                 \
            &xchain__contract__sdk__delete_response__descriptor) \
    }
...
#define XCHAIN__CONTRACT__SDK__ITERATOR_REQUEST__INIT             \
    {                                                             \
        PROTOBUF_C_MESSAGE_INIT(                                  \
            &xchain__contract__sdk__iterator_request__descriptor) \
...
#define XCHAIN__CONTRACT__SDK__ITERATOR_RESPONSE__INIT             \
    {                                                              \
        PROTOBUF_C_MESSAGE_INIT(                                   \
            &xchain__contract__sdk__iterator_response__descriptor) \
        , 0, NULL                                                  \
    }
...
#define XCHAIN__CONTRACT__SDK__QUERY_TX_REQUEST__INIT             \
    {                                                             \
        PROTOBUF_C_MESSAGE_INIT(                                  \
            &xchain__contract__sdk__query_tx_request__descriptor) \
...
#define XCHAIN__CONTRACT__SDK__QUERY_TX_RESPONSE__INIT             \
    {                                                              \
        PROTOBUF_C_MESSAGE_INIT(                                   \
            &xchain__contract__sdk__query_tx_response__descriptor) \
        , NULL                                                     \
    }
...
#define XCHAIN__CONTRACT__SDK__QUERY_BLOCK_REQUEST__INIT             \
    {                                                                \
        PROTOBUF_C_MESSAGE_INIT(                                     \
            &xchain__contract__sdk__query_block_request__descriptor) \
        , NULL, (char*)protobuf_c_empty_string                       \
    }
...
#define XCHAIN__CONTRACT__SDK__QUERY_BLOCK_RESPONSE__INIT             \
    {                                                                 \
        PROTOBUF_C_MESSAGE_INIT(                                      \
            &xchain__contract__sdk__query_block_response__descriptor) \
        , NULL                                                        \
    }
...
#define XCHAIN__CONTRACT__SDK__TRANSFER_REQUEST__INIT                      \
    {                                                                      \
        PROTOBUF_C_MESSAGE_INIT(                                           \
            &xchain__contract__sdk__transfer_request__descriptor)          \
        , NULL, (char*)protobuf_c_empty_string,                            \
...
#define XCHAIN__CONTRACT__SDK__TRANSFER_RESPONSE__INIT             \
    {                                                              \
        PROTOBUF_C_MESSAGE_INIT(                                   \
            &xchain__contract__sdk__transfer_response__descriptor) \
    }
...
#define XCHAIN__CONTRACT__SDK__CONTRACT_CALL_REQUEST__INIT                     \
    {                                                                          \
        PROTOBUF_C_MESSAGE_INIT(                                               \
            &xchain__contract__sdk__contract_call_request__descriptor)         \
        , NULL, (char*)protobuf_c_empty_string,                                \
...
#define XCHAIN__CONTRACT__SDK__CONTRACT_CALL_RESPONSE__INIT             \
    {                                                                   \
        PROTOBUF_C_MESSAGE_INIT(                                        \
            &xchain__contract__sdk__contract_call_response__descriptor) \
        , NULL                                                          \
    }
...
#define XCHAIN__CONTRACT__SDK__CROSS_CONTRACT_QUERY_REQUEST__INIT             \
    {                                                                         \
        PROTOBUF_C_MESSAGE_INIT(                                              \
            &xchain__contract__sdk__cross_contract_query_request__descriptor) \
...
#define XCHAIN__CONTRACT__SDK__CROSS_CONTRACT_QUERY_RESPONSE__INIT             \
    {                                                                          \
        PROTOBUF_C_MESSAGE_INIT(                                               \
            &xchain__contract__sdk__cross_contract_query_response__descriptor) \
        , NULL                                                                 \
    }
...
#define XCHAIN__CONTRACT__SDK__SET_OUTPUT_REQUEST__INIT             \
    {                                                               \
        PROTOBUF_C_MESSAGE_INIT(                                    \
            &xchain__contract__sdk__set_output_request__descriptor) \
        , NULL, NULL                                                \
    }
...
#define XCHAIN__CONTRACT__SDK__SET_OUTPUT_RESPONSE__INIT             \
    {                                                                \
        PROTOBUF_C_MESSAGE_INIT(                                     \
            &xchain__contract__sdk__set_output_response__descriptor) \
    }
...
#define XCHAIN__CONTRACT__SDK__GET_CALL_ARGS_REQUEST__INIT             \
    {                                                                  \
        PROTOBUF_C_MESSAGE_INIT(                                       \
            &xchain__contract__sdk__get_call_args_request__descriptor) \
        , NULL                                                         \
    }
...
#define XCHAIN__CONTRACT__SDK__TRANSACTION__INIT                              \
    {                                                                         \
        ...
        , (char*)protobuf_c_empty_string, (char*)protobuf_c_empty_string, 0,  \
            NULL, 0, NULL, {0, NULL}, (char*)protobuf_c_empty_string, 0, NULL \
    }
...
#define XCHAIN__CONTRACT__SDK__BLOCK__INIT                                    \
    {                                                                         \
        ...
        , (char*)protobuf_c_empty_string, (char*)protobuf_c_empty_string,     \
            {0, NULL}, (char*)protobuf_c_empty_string, {0, NULL}, 0, 0, NULL, \
...
#define XCHAIN__CONTRACT__SDK__GET_ACCOUNT_ADDRESSES_REQUEST__INIT             \
    {                                                                          \
        PROTOBUF_C_MESSAGE_INIT(                                               \
            &xchain__contract__sdk__get_account_addresses_request__descriptor) \
        , NULL, (char*)protobuf_c_empty_string                                 \
    }
...
#define XCHAIN__CONTRACT__SDK__GET_ACCOUNT_ADDRESSES_RESPONSE__INIT             \
    {                                                                           \
        PROTOBUF_C_MESSAGE_INIT(                                                \
            &xchain__contract__sdk__get_account_addresses_response__descriptor) \
        , 0, NULL                                                               \
    }
...
#define XCHAIN__CONTRACT__SDK__POST_LOG_REQUEST__INIT             \
    {                                                             \
        PROTOBUF_C_MESSAGE_INIT(                                  \
            &xchain__contract__sdk__post_log_request__descriptor) \
        , NULL, (char*)protobuf_c_empty_string                    \
    }
...
#define XCHAIN__CONTRACT__SDK__POST_LOG_RESPONSE__INIT             \
    {                                                              \
        PROTOBUF_C_MESSAGE_INIT(                                   \
            &xchain__contract__sdk__post_log_response__descriptor) \
        , (char*)protobuf_c_empty_string                           \
    }
...
#define XCHAIN__CONTRACT__SDK__EMIT_EVENT_REQUEST__INIT             \
    {                                                               \
        PROTOBUF_C_MESSAGE_INIT(                                    \
            &xchain__contract__sdk__emit_event_request__descriptor) \
        , NULL, (char*)protobuf_c_empty_string, { 0, NULL }         \
    }
...
#define XCHAIN__CONTRACT__SDK__EMIT_EVENT_RESPONSE__INIT             \
    {                                                                \
        PROTOBUF_C_MESSAGE_INIT(                                     \
            &xchain__contract__sdk__emit_event_response__descriptor) \
    }
...
size_t xchain__contract__sdk__ping_request__pack(
    const Xchain__Contract__Sdk__PingRequest* message, uint8_t* out);
size_t xchain__contract__sdk__ping_request__pack_to_buffer(
    const Xchain__Contract__Sdk__PingRequest* message, ProtobufCBuffer* buffer);
Xchain__Contract__Sdk__PingRequest* xchain__contract__sdk__ping_request__unpack(
    ProtobufCAllocator* allocator, size_t len, const uint8_t* data);
void xchain__contract__sdk__ping_request__free_unpacked(
    Xchain__Contract__Sdk__PingRequest* message, ProtobufCAllocator* allocator);
...
size_t xchain__contract__sdk__ping_response__pack(
    const Xchain__Contract__Sdk__PingResponse* message, uint8_t* out);
size_t xchain__contract__sdk__ping_response__pack_to_buffer(
    const Xchain__Contract__Sdk__PingResponse* message,
    ProtobufCBuffer* buffer);
Xchain__Contract__Sdk__PingResponse*
xchain__contract__sdk__ping_response__unpack(ProtobufCAllocator* allocator,
...
size_t xchain__contract__sdk__native_call_request__pack(
    const Xchain__Contract__Sdk__NativeCallRequest* message, uint8_t* out);
...
size_t xchain__contract__sdk__native_call_response__pack(
    const Xchain__Contract__Sdk__NativeCallResponse* message, uint8_t* out);
...
size_t xchain__contract__sdk__arg_pair__pack(
    const Xchain__Contract__Sdk__ArgPair* message, uint8_t* out);
size_t xchain__contract__sdk__arg_pair__pack_to_buffer(
    const Xchain__Contract__Sdk__ArgPair* message, ProtobufCBuffer* buffer);
Xchain__Contract__Sdk__ArgPair* xchain__contract__sdk__arg_pair__unpack(
    ProtobufCAllocator* allocator, size_t len, const uint8_t* data);
void xchain__contract__sdk__arg_pair__free_unpacked(
    Xchain__Contract__Sdk__ArgPair* message, ProtobufCAllocator* allocator);
...
size_t xchain__contract__sdk__call_args__pack(
    const Xchain__Contract__Sdk__CallArgs* message, uint8_t* out);
size_t xchain__contract__sdk__call_args__pack_to_buffer(
    const Xchain__Contract__Sdk__CallArgs* message, ProtobufCBuffer* buffer);
Xchain__Contract__Sdk__CallArgs* xchain__contract__sdk__call_args__unpack(
    ProtobufCAllocator* allocator, size_t len, const uint8_t* data);
void xchain__contract__sdk__call_args__free_unpacked(
    Xchain__Contract__Sdk__CallArgs* message, ProtobufCAllocator* allocator);
...
size_t xchain__contract__sdk__syscall_header__pack(
    const Xchain__Contract__Sdk__SyscallHeader* message, uint8_t* out);
size_t xchain__contract__sdk__syscall_header__pack_to_buffer(
    const Xchain__Contract__Sdk__SyscallHeader* message,
    ProtobufCBuffer* buffer);
Xchain__Contract__Sdk__SyscallHeader*
xchain__contract__sdk__syscall_header__unpack(ProtobufCAllocator* allocator,
                                              size_t len, const uint8_t* data);
...
size_t xchain__contract__sdk__put_request__pack(
    const Xchain__Contract__Sdk__PutRequest* message, uint8_t* out);
size_t xchain__contract__sdk__put_request__pack_to_buffer(
    const Xchain__Contract__Sdk__PutRequest* message, ProtobufCBuffer* buffer);
Xchain__Contract__Sdk__PutRequest* xchain__contract__sdk__put_request__unpack(
    ProtobufCAllocator* allocator, size_t len, const uint8_t* data);
void xchain__contract__sdk__put_request__free_unpacked(
    Xchain__Contract__Sdk__PutRequest* message, ProtobufCAllocator* allocator);
...
size_t xchain__contract__sdk__put_response__pack(
    const Xchain__Contract__Sdk__PutResponse* message, uint8_t* out);
size_t xchain__contract__sdk__put_response__pack_to_buffer(
    const Xchain__Contract__Sdk__PutResponse* message, ProtobufCBuffer* buffer);
Xchain__Contract__Sdk__PutResponse* xchain__contract__sdk__put_response__unpack(
    ProtobufCAllocator* allocator, size_t len, const uint8_t* data);
void xchain__contract__sdk__put_response__free_unpacked(
    Xchain__Contract__Sdk__PutResponse* message, ProtobufCAllocator* allocator);
...
size_t xchain__contract__sdk__get_request__pack(
    const Xchain__Contract__Sdk__GetRequest* message, uint8_t* out);
size_t xchain__contract__sdk__get_request__pack_to_buffer(
    const Xchain__Contract__Sdk__GetRequest* message, ProtobufCBuffer* buffer);
Xchain__Contract__Sdk__GetRequest* xchain__contract__sdk__get_request__unpack(
    ProtobufCAllocator* allocator, size_t len, const uint8_t* data);
void xchain__contract__sdk__get_request__free_unpacked(
    Xchain__Contract__Sdk__GetRequest* message, ProtobufCAllocator* allocator);
...
size_t xchain__contract__sdk__get_response__pack(
    const Xchain__Contract__Sdk__GetResponse* message, uint8_t* out);
size_t xchain__contract__sdk__get_response__pack_to_buffer(
    const Xchain__Contract__Sdk__GetResponse* message, ProtobufCBuffer* buffer);
Xchain__Contract__Sdk__GetResponse* xchain__contract__sdk__get_response__unpack(
    ProtobufCAllocator* allocator, size_t len, const uint8_t* data);
void xchain__contract__sdk__get_response__free_unpacked(
    Xchain__Contract__Sdk__GetResponse* message, ProtobufCAllocator* allocator);
...
size_t xchain__contract__sdk__delete_request__pack(
    const Xchain__Contract__Sdk__DeleteRequest* message, uint8_t* out);
size_t xchain__contract__sdk__delete_request__pack_to_buffer(
    const Xchain__Contract__Sdk__DeleteRequest* message,
    ProtobufCBuffer* buffer);
Xchain__Contract__Sdk__DeleteRequest*
xchain__contract__sdk__delete_request__unpack(ProtobufCAllocator* allocator,
                                              size_t len, const uint8_t* data);
...
size_t xchain__contract__sdk__delete_response__pack(
    const Xchain__Contract__Sdk__DeleteResponse* message, uint8_t* out);
size_t xchain__contract__sdk__delete_response__pack_to_buffer(
    const Xchain__Contract__Sdk__DeleteResponse* message,
    ProtobufCBuffer* buffer);
Xchain__Contract__Sdk__DeleteResponse*
xchain__contract__sdk__delete_response__unpack(ProtobufCAllocator* allocator,
                                               size_t len, const uint8_t* data);
...
size_t xchain__contract__sdk__iterator_request__pack(
    const Xchain__Contract__Sdk__IteratorRequest* message, uint8_t* out);
size_t xchain__contract__sdk__iterator_request__pack_to_buffer(
    const Xchain__Contract__Sdk__IteratorRequest* message,
    ProtobufCBuffer* buffer);
Xchain__Contract__Sdk__IteratorRequest*
xchain__contract__sdk__iterator_request__unpack(ProtobufCAllocator* allocator,
                                                size_t len,
                                                const uint8_t* data);
...
size_t xchain__contract__sdk__iterator_item__pack(
    const Xchain__Contract__Sdk__IteratorItem* message, uint8_t* out);
size_t xchain__contract__sdk__iterator_item__pack_to_buffer(
    const Xchain__Contract__Sdk__IteratorItem* message,
    ProtobufCBuffer* buffer);
Xchain__Contract__Sdk__IteratorItem*
xchain__contract__sdk__iterator_item__unpack(ProtobufCAllocator* allocator,
                                             size_t len, const uint8_t* data);
...
size_t xchain__contract__sdk__iterator_response__pack(
    const Xchain__Contract__Sdk__IteratorResponse* message, uint8_t* out);
size_t xchain__contract__sdk__iterator_response__pack_to_buffer(
    const Xchain__Contract__Sdk__IteratorResponse* message,
    ProtobufCBuffer* buffer);
Xchain__Contract__Sdk__IteratorResponse*
xchain__contract__sdk__iterator_response__unpack(ProtobufCAllocator* allocator,
                                                 size_t len,
                                                 const uint8_t* data);
...
size_t xchain__contract__sdk__query_tx_request__pack(
    const Xchain__Contract__Sdk__QueryTxRequest* message, uint8_t* out);
size_t xchain__contract__sdk__query_tx_request__pack_to_buffer(
    const Xchain__Contract__Sdk__QueryTxRequest* message,
    ProtobufCBuffer* buffer);
Xchain__Contract__Sdk__QueryTxRequest*
xchain__contract__sdk__query_tx_request__unpack(ProtobufCAllocator* allocator,
                                                size_t len,
                                                const uint8_t* data);
...
size_t xchain__contract__sdk__query_tx_response__pack(
    const Xchain__Contract__Sdk__QueryTxResponse* message, uint8_t* out);
size_t xchain__contract__sdk__query_tx_response__pack_to_buffer(
    const Xchain__Contract__Sdk__QueryTxResponse* message,
    ProtobufCBuffer* buffer);
Xchain__Contract__Sdk__QueryTxResponse*
xchain__contract__sdk__query_tx_response__unpack(ProtobufCAllocator* allocator,
                                                 size_t len,
                                                 const uint8_t* data);
...
size_t xchain__contract__sdk__query_block_request__pack(
    const Xchain__Contract__Sdk__QueryBlockRequest* message, uint8_t* out);
...
size_t xchain__contract__sdk__query_block_response__pack(
    const Xchain__Contract__Sdk__QueryBlockResponse* message, uint8_t* out);
...
size_t xchain__contract__sdk__transfer_request__pack(
    const Xchain__Contract__Sdk__TransferRequest* message, uint8_t* out);
size_t xchain__contract__sdk__transfer_request__pack_to_buffer(
    const Xchain__Contract__Sdk__TransferRequest* message,
    ProtobufCBuffer* buffer);
Xchain__Contract__Sdk__TransferRequest*
xchain__contract__sdk__transfer_request__unpack(ProtobufCAllocator* allocator,
                                                size_t len,
                                                const uint8_t* data);
...
size_t xchain__contract__sdk__transfer_response__pack(
    const Xchain__Contract__Sdk__TransferResponse* message, uint8_t* out);
size_t xchain__contract__sdk__transfer_response__pack_to_buffer(
    const Xchain__Contract__Sdk__TransferResponse* message,
    ProtobufCBuffer* buffer);
Xchain__Contract__Sdk__TransferResponse*
xchain__contract__sdk__transfer_response__unpack(ProtobufCAllocator* allocator,
                                                 size_t len,
                                                 const uint8_t* data);
...
size_t xchain__contract__sdk__contract_call_request__pack(
    const Xchain__Contract__Sdk__ContractCallRequest* message, uint8_t* out);
...
size_t xchain__contract__sdk__contract_call_response__pack(
    const Xchain__Contract__Sdk__ContractCallResponse* message, uint8_t* out);
...
size_t xchain__contract__sdk__response__pack(
    const Xchain__Contract__Sdk__Response* message, uint8_t* out);
size_t xchain__contract__sdk__response__pack_to_buffer(
    const Xchain__Contract__Sdk__Response* message, ProtobufCBuffer* buffer);
Xchain__Contract__Sdk__Response* xchain__contract__sdk__response__unpack(
    ProtobufCAllocator* allocator, size_t len, const uint8_t* data);
void xchain__contract__sdk__response__free_unpacked(
    Xchain__Contract__Sdk__Response* message, ProtobufCAllocator* allocator);
...
size_t xchain__contract__sdk__set_output_request__pack(
    const Xchain__Contract__Sdk__SetOutputRequest* message, uint8_t* out);
size_t xchain__contract__sdk__set_output_request__pack_to_buffer(
    const Xchain__Contract__Sdk__SetOutputRequest* message,
    ProtobufCBuffer* buffer);
Xchain__Contract__Sdk__SetOutputRequest*
xchain__contract__sdk__set_output_request__unpack(ProtobufCAllocator* allocator,
                                                  size_t len,
                                                  const uint8_t* data);
...
size_t xchain__contract__sdk__set_output_response__pack(
    const Xchain__Contract__Sdk__SetOutputResponse* message, uint8_t* out);
...
size_t xchain__contract__sdk__get_call_args_request__pack(
    const Xchain__Contract__Sdk__GetCallArgsRequest* message, uint8_t* out);
...
size_t xchain__contract__sdk__tx_input__pack(
    const Xchain__Contract__Sdk__TxInput* message, uint8_t* out);
size_t xchain__contract__sdk__tx_input__pack_to_buffer(
    const Xchain__Contract__Sdk__TxInput* message, ProtobufCBuffer* buffer);
Xchain__Contract__Sdk__TxInput* xchain__contract__sdk__tx_input__unpack(
    ProtobufCAllocator* allocator, size_t len, const uint8_t* data);
void xchain__contract__sdk__tx_input__free_unpacked(
    Xchain__Contract__Sdk__TxInput* message, ProtobufCAllocator* allocator);
...
size_t xchain__contract__sdk__tx_output__pack(
    const Xchain__Contract__Sdk__TxOutput* message, uint8_t* out);
size_t xchain__contract__sdk__tx_output__pack_to_buffer(
    const Xchain__Contract__Sdk__TxOutput* message, ProtobufCBuffer* buffer);
Xchain__Contract__Sdk__TxOutput* xchain__contract__sdk__tx_output__unpack(
    ProtobufCAllocator* allocator, size_t len, const uint8_t* data);
void xchain__contract__sdk__tx_output__free_unpacked(
    Xchain__Contract__Sdk__TxOutput* message, ProtobufCAllocator* allocator);
...
size_t xchain__contract__sdk__transaction__pack(
    const Xchain__Contract__Sdk__Transaction* message, uint8_t* out);
size_t xchain__contract__sdk__transaction__pack_to_buffer(
    const Xchain__Contract__Sdk__Transaction* message, ProtobufCBuffer* buffer);
Xchain__Contract__Sdk__Transaction* xchain__contract__sdk__transaction__unpack(
    ProtobufCAllocator* allocator, size_t len, const uint8_t* data);
void xchain__contract__sdk__transaction__free_unpacked(
    Xchain__Contract__Sdk__Transaction* message, ProtobufCAllocator* allocator);
/* Xchain__Contract__Sdk__Block methods */
void xchain__contract__sdk__block__init(Xchain__Contract__Sdk__Block* message);
...
size_t xchain__contract__sdk__block__pack(
    const Xchain__Contract__Sdk__Block* message, uint8_t* out);
size_t xchain__contract__sdk__block__pack_to_buffer(
    const Xchain__Contract__Sdk__Block* message, ProtobufCBuffer* buffer);
Xchain__Contract__Sdk__Block* xchain__contract__sdk__block__unpack(
    ProtobufCAllocator* allocator, size_t len, const uint8_t* data);
void xchain__contract__sdk__block__free_unpacked(
    Xchain__Contract__Sdk__Block* message, ProtobufCAllocator* allocator);
...
size_t xchain__contract__sdk__post_log_request__pack(
    const Xchain__Contract__Sdk__PostLogRequest* message, uint8_t* out);
size_t xchain__contract__sdk__post_log_request__pack_to_buffer(
    const Xchain__Contract__Sdk__PostLogRequest* message,
    ProtobufCBuffer* buffer);
Xchain__Contract__Sdk__PostLogRequest*
xchain__contract__sdk__post_log_request__unpack(ProtobufCAllocator* allocator,
                                                size_t len,
                                                const uint8_t* data);
...
size_t xchain__contract__sdk__post_log_response__pack(
    const Xchain__Contract__Sdk__PostLogResponse* message, uint8_t* out);
size_t xchain__contract__sdk__post_log_response__pack_to_buffer(
    const Xchain__Contract__Sdk__PostLogResponse* message,
    ProtobufCBuffer* buffer);
Xchain__Contract__Sdk__PostLogResponse*
xchain__contract__sdk__post_log_response__unpack(ProtobufCAllocator* allocator,
                                                 size_t len,
                                                 const uint8_t* data);
...
size_t xchain__contract__sdk__emit_event_request__pack(
    const Xchain__Contract__Sdk__EmitEventRequest* message, uint8_t* out);
size_t xchain__contract__sdk__emit_event_request__pack_to_buffer(
    const Xchain__Contract__Sdk__EmitEventRequest* message,
    ProtobufCBuffer* buffer);
Xchain__Contract__Sdk__EmitEventRequest*
xchain__contract__sdk__emit_event_request__unpack(ProtobufCAllocator* allocator,
                                                  size_t len,
                                                  const uint8_t* data);
...
size_t xchain__contract__sdk__emit_event_response__pack(
    const Xchain__Contract__Sdk__EmitEventResponse* message, uint8_t* out);
...
typedef void (*Xchain__Contract__Sdk__PingRequest_Closure)(
    const Xchain__Contract__Sdk__PingRequest* message, void* closure_data);
typedef void (*Xchain__Contract__Sdk__PingResponse_Closure)(
    const Xchain__Contract__Sdk__PingResponse* message, void* closure_data);
...
typedef void (*Xchain__Contract__Sdk__ArgPair_Closure)(
    const Xchain__Contract__Sdk__ArgPair* message, void* closure_data);
typedef void (*Xchain__Contract__Sdk__CallArgs_Closure)(
    const Xchain__Contract__Sdk__CallArgs* message, void* closure_data);
typedef void (*Xchain__Contract__Sdk__SyscallHeader_Closure)(
    const Xchain__Contract__Sdk__SyscallHeader* message, void* closure_data);
typedef void (*Xchain__Contract__Sdk__PutRequest_Closure)(
    const Xchain__Contract__Sdk__PutRequest* message, void* closure_data);
typedef void (*Xchain__Contract__Sdk__PutResponse_Closure)(
    const Xchain__Contract__Sdk__PutResponse* message, void* closure_data);
typedef void (*Xchain__Contract__Sdk__GetRequest_Closure)(
    const Xchain__Contract__Sdk__GetRequest* message, void* closure_data);
typedef void (*Xchain__Contract__Sdk__GetResponse_Closure)(
    const Xchain__Contract__Sdk__GetResponse* message, void* closure_data);
typedef void (*Xchain__Contract__Sdk__DeleteRequest_Closure)(
    const Xchain__Contract__Sdk__DeleteRequest* message, void* closure_data);
typedef void (*Xchain__Contract__Sdk__DeleteResponse_Closure)(
    const Xchain__Contract__Sdk__DeleteResponse* message, void* closure_data);
typedef void (*Xchain__Contract__Sdk__IteratorRequest_Closure)(
    const Xchain__Contract__Sdk__IteratorRequest* message, void* closure_data);
typedef void (*Xchain__Contract__Sdk__IteratorItem_Closure)(
    const Xchain__Contract__Sdk__IteratorItem* message, void* closure_data);
typedef void (*Xchain__Contract__Sdk__IteratorResponse_Closure)(
    const Xchain__Contract__Sdk__IteratorResponse* message, void* closure_data);
typedef void (*Xchain__Contract__Sdk__QueryTxRequest_Closure)(
    const Xchain__Contract__Sdk__QueryTxRequest* message, void* closure_data);
typedef void (*Xchain__Contract__Sdk__QueryTxResponse_Closure)(
    const Xchain__Contract__Sdk__QueryTxResponse* message, void* closure_data);
...
typedef void (*Xchain__Contract__Sdk__TransferRequest_Closure)(
    const Xchain__Contract__Sdk__TransferRequest* message, void* closure_data);
typedef void (*Xchain__Contract__Sdk__TransferResponse_Closure)(
    const Xchain__Contract__Sdk__TransferResponse* message, void* closure_data);
...
typedef void (*Xchain__Contract__Sdk__Response_Closure)(
    const Xchain__Contract__Sdk__Response* message, void* closure_data);
typedef void (*Xchain__Contract__Sdk__SetOutputRequest_Closure)(
    const Xchain__Contract__Sdk__SetOutputRequest* message, void* closure_data);
...
typedef void (*Xchain__Contract__Sdk__TxInput_Closure)(
    const Xchain__Contract__Sdk__TxInput* message, void* closure_data);
typedef void (*Xchain__Contract__Sdk__TxOutput_Closure)(
    const Xchain__Contract__Sdk__TxOutput* message, void* closure_data);
typedef void (*Xchain__Contract__Sdk__Transaction_Closure)(
    const Xchain__Contract__Sdk__Transaction* message, void* closure_data);
typedef void (*Xchain__Contract__Sdk__Block_Closure)(
    const Xchain__Contract__Sdk__Block* message, void* closure_data);
...
typedef void (*Xchain__Contract__Sdk__PostLogRequest_Closure)(
    const Xchain__Contract__Sdk__PostLogRequest* message, void* closure_data);
typedef void (*Xchain__Contract__Sdk__PostLogResponse_Closure)(
    const Xchain__Contract__Sdk__PostLogResponse* message, void* closure_data);
typedef void (*Xchain__Contract__Sdk__EmitEventRequest_Closure)(
    const Xchain__Contract__Sdk__EmitEventRequest* message, void* closure_data);
...
extern const ProtobufCMessageDescriptor
    xchain__contract__sdk__call_args__descriptor;
extern const ProtobufCMessageDescriptor
    xchain__contract__sdk__syscall_header__descriptor;
extern const ProtobufCMessageDescriptor
    xchain__contract__sdk__put_request__descriptor;
